        ...
        <div class="container-word">
          <div>
            ...
            <div class="logo-play-container">
              <object class="logo-play" title="play" type="image/svg+xml" data="assets/images/icon-play.svg"></object>
            </div>
        ...
        <div class="source-container">
          ...
          <div>
           <a class="link-container" href="${data[0].sourceUrls[0]}" target="_blank">
             ...
             <object class="logo-new-window" title="new window" type="image/svg+xml" data="assets/images/icon-new-window.svg"></object>
           </a>
          </div>
        </div>
      </div>
...
const setPage = async function() {
  ...
  try {
    ...
    // To add dark mode properties for word content
...
document.body.addEventListener("click", function(e) {
  ...
  // Open new page with the synosym clicked
